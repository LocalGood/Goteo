...
$elements      = array(
    ...
    'preview' => array(
        ...
        'html'      =>   '<div class="project-preview" style="position: relative"><div>'
                       ...
                       . new View('view/skillmatching/widget/media.html.php', array('skillmatching' => $project))
                       . new View('view/skillmatching/widget/share.html.php', array('skillmatching' => $project))
