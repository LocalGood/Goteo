            ...
            <fieldset>
                ...
                <div class="steps">
                    ...
                    <span class="step first-off off<?php if ($this['step'] === 'userProfile') echo ' active'; else echo ' activable'; ?>">
                        <button type="submit" name="view-step-userProfile" value="<?php echo Text::get('step-1-sm'); ?>"><?php echo Text::get('step-1-sm'); ?>
                    ...
                    <span class="step off-off off<?php if ($this['step'] === 'userPersonal') echo ' active'; else echo ' activable'; ?>">
                        <button type="submit" name="view-step-userPersonal" value="<?php echo Text::get('step-2-sm'); ?>"><?php echo Text::get('step-2-sm'); ?>
                        <strong class="number">2</strong></button>
                    </span>
                    
                    <fieldset style="display: inline">
                        
                        <legend><?php echo Text::get('regular-new_skillmatching'); ?></legend>
                        
                        <span class="step off-on<?php if ($this['step'] === 'overview') echo ' active'; else echo ' activable'; ?>">
                            <button type="submit" name="view-step-overview" value="<?php echo Text::get('step-3-sm'); ?>"><?php echo Text::get('step-3-sm'); ?>
                            <strong class="number">3</strong></button>                            
                        </span>
                        <span class="step on-on<?php if ($this['step'] === 'rewards') echo ' active'; else echo ' activable'; ?>">
                            <button type="submit" name="view-step-rewards" value="<?php echo Text::get('step-4-sm'); ?>"><?php echo Text::get('step-4-sm'); ?>
                            <strong class="number">4</strong></button>
                        </span>

                        <span class="step on-off<?php if ($this['step'] === 'supports') echo ' active'; else echo ' activable'; ?>">
                            <button type="submit" name="view-step-supports" value="<?php echo Text::get('step-5-sm'); ?>"><?php echo Text::get('step-5-sm'); ?>
                    ...
                    <span class="step off-last off<?php if ($this['step'] === 'preview') echo ' active'; else echo ' activable'; ?>">
                        <button type="submit" name="view-step-preview" value="<?php echo Text::get('step-6-sm'); ?>"><?php echo Text::get('step-6-sm'); ?>
