...
<!--            <span class="cf-icon"></span>-->
        ...
        <div class="buttons">
            ...
            <a class="button red suportit" href="<?php echo LG_BASE_URL_GT ?>/project/edit/<?php echo $project->id ?>"><?php echo Text::get('regular-edit'); ?></a>
            <?php endif; ?>
            <a class="button view" href="<?php echo LG_BASE_URL_GT ?>/project/<?php echo $project->id ?>" target="_blank"><?php echo Text::get('regular-view_project'); ?></a>
        </div>
        <?php else : // normal ?>
        <div class="buttons">
            <?php if ($project->status == 3) : // si esta en campa�a se puede aportar ?>
            <a class="button violet supportit" href="<?php echo LG_BASE_URL_GT ?>/project/<?php echo $project->id ?>/invest"<?php echo $blank; ?>><?php echo Text::get('regular-invest_it'); ?></a>
            <?php else : ?>
            <a class="button view" href="<?php echo LG_BASE_URL_GT ?>/project/<?php echo $project->id ?>/updates"<?php echo $blank; ?>><?php echo Text::get('regular-see_blog'); ?></a>
            <?php endif; ?>
            <a class="button view" href="<?php echo LG_BASE_URL_GT ?>/project/<?php echo $project->id ?>"<?php echo $blank; ?>><?php echo Text::get('regular-view_project'); ?></a>
        </div>
        <?php endif;
         *
         */
